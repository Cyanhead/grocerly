...
export const WishlistButtonWrap = styled.div`
  display: flex;
...
export const WishlistButtonCounterWrap = styled.div`
  display: flex;
  justify-content: center;
  align-items: center;
...
export const WishlistButtonCounter = styled.div`
  display: flex;
  justify-content: center;
  align-items: center;
...
export const WishlistButtonP = styled.p`
  margin-left: 2px;
